...
import { PatchUserDTO, ResponseUserDTO, UpdatePasswordDTO } from '../user/user.dto';
...
export interface IUserService {
   ...
   updatePassword: (userID: number, paramsUserID: number, update: UpdatePasswordDTO) => Promise<void>;
}
